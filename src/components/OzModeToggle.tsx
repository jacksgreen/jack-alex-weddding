...
const OzModeToggle = () => {
  ...
  return (
    <button
      ...
      className={`fixed bottom-24 pr-6 pl-4 right-[-110px] hover:-right-4 z-[100] border-[3px] rounded-lg transition-all duration-300 p-3 flex items-center gap-3 font-bold ${
        isOzMode
